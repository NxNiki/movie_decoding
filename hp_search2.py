...
if __name__ == '__main__':
    ...
    for patient, sd, dd in zip(patient_list, sd_list, data_list):
        for data_type in ['clusterless']:
            ...
            train_save_path = os.path.join(root_path, 'results/8concepts/{}_{}_{}_{}/train'.format(args['patient'], data_type, model_architecture, suffix))
            valid_save_path = os.path.join(root_path, 'results/8concepts/{}_{}_{}_{}/valid'.format(args['patient'], data_type, model_architecture, suffix))
            test_save_path = os.path.join(root_path, 'results/8concepts/{}_{}_{}_{}/test'.format(args['patient'], data_type, model_architecture, suffix))
            memory_save_path = os.path.join(root_path, 'results/8concepts/{}_{}_{}_{}/memory'.format(args['patient'], data_type, model_architecture, suffix))
            ...
            print("Best trial final validation loss: {}".format(best_result.metrics["recall"]))
            print("Best trial final validation accuracy: {}".format(best_result.metrics["jack"]))
