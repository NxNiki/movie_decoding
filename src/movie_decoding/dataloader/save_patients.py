...
file_path = Path(__file__).resolve().parents[3] / "data/patients"
patients.export_json(file_path)
file_path = Path(__file__).resolve().parents[3] / "data/surrogate_windows"
surrogate_windows.export_json(file_path)
