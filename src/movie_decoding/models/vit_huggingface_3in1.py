...
class ViTEmbeddings(nn.Module):
    ...
    def forward(
        ...
        embeddings1 = self.patch_embeddings(
            pixel_values["sf2000"], interpolate_pos_encoding=interpolate_pos_encoding
        )
        embeddings2 = self.patch_embeddings2(
            pixel_values["sf1000"], interpolate_pos_encoding=interpolate_pos_encoding
        )
        embeddings3 = self.patch_embeddings3(
            pixel_values["sf500"], interpolate_pos_encoding=interpolate_pos_encoding
        )
