...
class InferenceDataset(Dataset):
    def __init__(
        ...
        if lfp:
            self.sample_range = [
                (self.alignment_offset + FREE_RECALL_LFP_TIME[patient + "_" + str(phase)][0]) * self.lfp_sf,
        ...
        if spike:
            self.frame_range = [
                (self.alignment_offset + FREE_RECALL_SPIKE_TIME[patient + "_" + str(phase)][0])
                * self.movie_sampling_rate,
                (self.alignment_offset + FREE_RECALL_SPIKE_TIME[patient + "_" + str(phase)][1])
                * self.movie_sampling_rate,
            ]
