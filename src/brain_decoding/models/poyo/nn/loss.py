...
from src.models.poyo.taxonomy import OutputType
...
def compute_loss_or_metric(
    ...
    if output_type == OutputType.CONTINUOUS:
        if loss_or_metric == "mse":
            ...
            raise NotImplementedError(f"Loss/Metric {loss_or_metric} not implemented for continuous output")
    ...
    if output_type in [
        ...
        if loss_or_metric == "bce":
            ...
            raise NotImplementedError(f"Loss/Metric {loss_or_metric} not implemented for binary/multilabel " "output")

    raise NotImplementedError("I don't know how to handle this task type. Implement plis")
